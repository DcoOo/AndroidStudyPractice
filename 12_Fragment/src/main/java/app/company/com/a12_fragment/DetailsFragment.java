...
public class DetailsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        switch (mParam1){
            case "1":
                tv_word.setText("Apple");
                tv_sample.setText("This is an apple");
                break;
            case "2":
                tv_word.setText("Banana");
                tv_sample.setText("This is a Banana");
                break;
            case "3":
                tv_word.setText("Orange");
                tv_sample.setText("This is an orange");
                break;
        }
